...
const Puissance4 = () => {
  ...
  if (videoOpen) {
    videoContent = (
      <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75 z-50">
        <div className="relative max-w-4xl mx-auto p-4 rounded-lg video">
  ...
  return (
    <div className="flex flex-col items-center text-center py-16 px-4">
      <div className="mb-12" data-aos="fade-in">
        ...
        <p className='text-white transform transition-transform hover:scale-105 duration-500'>
          Exercice de manipulation du DOM
        </p>
        <Link to="https://github.com/MathieuGaudron/Puissance_4" target="_blank" rel="noopener noreferrer" className='flex justify-center py-10'>
