    ...
    <div className="flex flex-col items-center text-center py-16 px-4">
      <div className="mb-12" data-aos="fade-in">
        ...
        <p className='text-white'>
          <span className='font-bold text-white'>Technologie utilisée : </span>
          REACT - TAILWIND / SYMFONY
        </p>
        <p className='text-white transform transition-transform hover:scale-105 duration-500'>
          Projet d'école visant à reproduire un site Ecommerce
        </p>
        <p className='text-white transform transition-transform hover:scale-105 duration-500'>
          Ce projet est encore en construction . . .
        </p>
      </div>
      ...
      {/* Commenté pour l'instant, mais vous pouvez ajouter l'animation plus tard */}
